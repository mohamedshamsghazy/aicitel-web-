    ...
    return (
        <section id="system" className="py-32 bg-slate-50 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 text-center">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-primary mb-20 tracking-tight">{t('title')}</h2>
                ...
                <div className="grid md:grid-cols-4 gap-8 relative">
                    ...
                    {/* Step 1 */}
                    <div className="relative p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group z-10 border border-slate-200">
                        ...
                        <h3 className="text-xl font-bold text-primary mb-4 group-hover:text-accent transition-colors">{t('steps.recruiting.title')}</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">{t('steps.recruiting.description')}</p>
                    </div>
                    ...
                    <div className="relative p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group z-10 border border-slate-200">
                        ...
                        <h3 className="text-xl font-bold text-primary mb-4 group-hover:text-accent transition-colors">{t('steps.training.title')}</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">{t('steps.training.description')}</p>
                    </div>
                    ...
                    <div className="relative p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group z-10 border border-slate-200">
                        ...
                        <h3 className="text-xl font-bold text-primary mb-4 group-hover:text-accent transition-colors">{t('steps.deployment.title')}</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">{t('steps.deployment.description')}</p>
                    </div>
                    ...
                    <div className="relative p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group z-10 border border-slate-200">
                        ...
                        <h3 className="text-xl font-bold text-primary mb-4 group-hover:text-accent transition-colors">{t('steps.optimization.title')}</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">{t('steps.optimization.description')}</p>
                    </div>
                </div>
            </div>
        </section>
